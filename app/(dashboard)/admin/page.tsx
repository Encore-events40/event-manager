  ...
  return (
    <div className="min-h-screen bg-[#F6F4F3] flex items-center justify-center p-8">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-black mb-1">Admin Control Centre</h1>
        <p className="text-gray-500 text-sm mb-6">Signed in as <span className="font-semibold text-gray-700">{user.email}</span></p>
        <div className="inline-block bg-red-100 text-red-600 text-xs font-bold px-3 py-1 rounded-full mb-8">
          ROLE: ADMIN
        </div>
        <div>
          <SignOutButton />
